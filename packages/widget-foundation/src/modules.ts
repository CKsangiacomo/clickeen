export const WIDGET_SHARED_CSS_MODULE_KEYS = [
...
export const WIDGET_PACKAGE_STYLE_CHUNK_END = '/* ck-style-module:end */';
export const WIDGET_PACKAGE_RUNTIME_PAYLOAD_START = '/* ck-runtime-payload:start */';
export const WIDGET_PACKAGE_RUNTIME_PAYLOAD_END = '/* ck-runtime-payload:end */';
export const WIDGET_PACKAGE_RUNTIME_MODULE_END = '/* ck-runtime-module:end */';
