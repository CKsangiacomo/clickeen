...
export function buildStagePodLayoutPanelFields(options: StagePodLayoutPanelOptions = {}): string[] {
  ...
  return [
    ...
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='pod.contentWidth' label='Width in pixels' min='0' show-if=\"pod.widthMode == 'fixed'\" />",
    ...
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='pod.padding.desktop.all' label='Pod padding (desktop px)' min='0' show-if=\"pod.padding.desktop.linked == true\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='pod.padding.desktop.top' label='Pod top padding (desktop px)' min='0' show-if=\"pod.padding.desktop.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='pod.padding.desktop.right' label='Pod right padding (desktop px)' min='0' show-if=\"pod.padding.desktop.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='pod.padding.desktop.bottom' label='Pod bottom padding (desktop px)' min='0' show-if=\"pod.padding.desktop.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='pod.padding.desktop.left' label='Pod left padding (desktop px)' min='0' show-if=\"pod.padding.desktop.linked == false\" />",
    ...
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='pod.padding.mobile.all' label='Pod padding (mobile px)' min='0' show-if=\"pod.padding.mobile.linked == true\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='pod.padding.mobile.top' label='Pod top padding (mobile px)' min='0' show-if=\"pod.padding.mobile.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='pod.padding.mobile.right' label='Pod right padding (mobile px)' min='0' show-if=\"pod.padding.mobile.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='pod.padding.mobile.bottom' label='Pod bottom padding (mobile px)' min='0' show-if=\"pod.padding.mobile.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='pod.padding.mobile.left' label='Pod left padding (mobile px)' min='0' show-if=\"pod.padding.mobile.linked == false\" />",
    '  </tooldrawer-cluster>',
    ...
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.canvas.width' label='Stage width (px)' min='0' show-if=\"stage.canvas.mode == 'fixed'\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.canvas.height' label='Stage height (px)' min='0' show-if=\"stage.canvas.mode == 'fixed'\" />",
    ...
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.padding.desktop.all' label='Stage padding (desktop px)' min='0' show-if=\"stage.padding.desktop.linked == true\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.padding.desktop.top' label='Stage top padding (desktop px)' min='0' show-if=\"stage.padding.desktop.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.padding.desktop.right' label='Stage right padding (desktop px)' min='0' show-if=\"stage.padding.desktop.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.padding.desktop.bottom' label='Stage bottom padding (desktop px)' min='0' show-if=\"stage.padding.desktop.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.padding.desktop.left' label='Stage left padding (desktop px)' min='0' show-if=\"stage.padding.desktop.linked == false\" />",
    ...
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.padding.mobile.all' label='Stage padding (mobile px)' min='0' show-if=\"stage.padding.mobile.linked == true\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.padding.mobile.top' label='Stage top padding (mobile px)' min='0' show-if=\"stage.padding.mobile.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.padding.mobile.right' label='Stage right padding (mobile px)' min='0' show-if=\"stage.padding.mobile.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.padding.mobile.bottom' label='Stage bottom padding (mobile px)' min='0' show-if=\"stage.padding.mobile.linked == false\" />",
    "    <tooldrawer-field-podstagelayout group-label='' type='valuefield' size='md' path='stage.padding.mobile.left' label='Stage left padding (mobile px)' min='0' show-if=\"stage.padding.mobile.linked == false\" />",
    '  </tooldrawer-cluster>',
  ];
}
