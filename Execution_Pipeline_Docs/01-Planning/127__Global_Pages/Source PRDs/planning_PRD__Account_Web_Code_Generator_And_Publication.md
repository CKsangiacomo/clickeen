...
> **Historical input only. Do not execute this document.** The deferred future
> Page planning direction is recorded in `../127__PRD__Global_Pages_Program.md`
> and 127A–127F.
> In particular, this planning draft's placement-only model, navigation-based
> Bob return flow, and earlier Page preview assumptions are superseded by Page
> Rows, the in-frame slide-in Bob interaction, current saved-output
> Optimization, and the explicit runtime corrections in 127A, 127B, and 127E.
