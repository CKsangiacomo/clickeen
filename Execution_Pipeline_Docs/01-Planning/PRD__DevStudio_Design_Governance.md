# PRD — DevStudio Design Governance
...
- This page is the product owner's stated primary use case: *change the size of a
  typography token from DevStudio*. See §3.5.
...
- **Scope v1 (deliberately narrow): edit the *values* of existing tokens.**
...
- The Policy section (owned by the Migration PRD and 108A-1/Step 8).
