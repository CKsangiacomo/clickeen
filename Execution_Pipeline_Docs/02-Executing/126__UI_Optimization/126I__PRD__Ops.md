...
Status: DIRECTIONAL — fill after the ops audit (`audits/126I__Audit__Ops.md`).
...
## Role
The UI runbook — how Dieter is built, served, versioned, and governed. "How the system runs" (distinct from 126E Dieter, "what the system is").
