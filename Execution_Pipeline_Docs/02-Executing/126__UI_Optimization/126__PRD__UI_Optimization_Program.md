...
6. In progress: 126A through 126L completed Step 9 in the accepted dependency
   order, including 126G before 126F. Continue with 126M in dependency order.
   Execute one PRD and one slice at a time; a slice
