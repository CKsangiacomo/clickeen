...
| 124D Tokyo product roots | Executing | TOKYO-R2-002 deleted dead `tokyo/_redirects` and removed stale workflow path triggers for that ignored file. | TOKYO-R2-001 and TOKYO-R2-003 through TOKYO-R2-009 remain open. |
