...
Archive note: this document is no longer active execution authority. It is retained as evidence for the V1 instance registry/control table. PRD 105 supersedes this document wherever instance-folder source/artifact taxonomy conflicts.
