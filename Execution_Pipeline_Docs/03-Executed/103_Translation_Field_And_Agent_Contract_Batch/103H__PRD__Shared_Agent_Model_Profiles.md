...
Status: Historical evidence / shared policy proof green; surviving doctrine extracted to PRD 105E
Owner: Product + Architecture
Date: 2026-05-17
Parent: `103__PRD__Saved_Instance_Localization_Runtime.md`
Depends on: PRD 103B, PRD 103C, PRD 103G, PRD 103J, PRD 103K

Archive note: this document is no longer active execution authority. It is retained as evidence that Translation/Copilot model routing belongs to the shared policy path.
