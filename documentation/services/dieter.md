...
Use the Cloudflare DevStudio Dieter showcase to review the current component set and rendered markup.
...
2. Build Dieter media into Tokyo:
   ...
   ```
3. Verify visually in the Berlin-authenticated Cloudflare DevStudio at
...
DevStudio (`admin/`) is the preview harness for Dieter. It loads component specs and markup snippets directly from `dieter/components/*` and renders per-component pages generated by `admin/scripts/generate-component-pages.ts`.

### 2.1 Viewing

- Canonical surface: `https://devstudio.clickeen.com`
- Dieter showcase routes:
  - `/#/dieter/` (curated showcases)
  - `/#/dieter/{slug}` (generated per-component pages)
