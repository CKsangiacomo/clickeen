...
PRD 103_00 NOTE: this file now describes the intended product-operation model after the pre-103 source-model cleanup. `Execution_Pipeline_Docs/02-Executing/103_03__PRD__Translation_Generation_Job_State.md` added Tokyo-owned translation generation job state after human smoke proved Bob could show "Generating translations..." while no Tokyo generation job existed. The automated implementation is green; deployed Roma/Bob smoke remains the release gate.
