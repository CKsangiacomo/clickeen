...
```json
{
  ...
  "html": [
    ...
    "  <tooldrawer-cluster>",
    "    <tooldrawer-eyebrow text='Instagram source' />",
    ...
    "<bob-panel id='layout'>",
    "  <tooldrawer-cluster>",
    "    <tooldrawer-eyebrow text='Layout mode' />",
    ...
    "    <tooldrawer-eyebrow text='Masonry columns' />",
    ...
    "  </tooldrawer-cluster>",
    "  <tooldrawer-cluster>",
    "    <tooldrawer-eyebrow text='Spacing' />",
    ...
    "  <tooldrawer-cluster>",
    "    <tooldrawer-eyebrow text='Post style' />",
    ...
    "  </tooldrawer-cluster>",
    "  <tooldrawer-cluster>",
    "    <tooldrawer-eyebrow text='Overlay' />",
    ...
    "  </tooldrawer-cluster>",
    "  <tooldrawer-cluster>",
    "    <tooldrawer-eyebrow text='Colors' />",
    ...
    "  <tooldrawer-cluster>",
    "    <tooldrawer-eyebrow text='Loading' />",
    ...
    "  </tooldrawer-cluster>",
    "  <tooldrawer-cluster>",
    "    <tooldrawer-eyebrow text='Click action' />",
