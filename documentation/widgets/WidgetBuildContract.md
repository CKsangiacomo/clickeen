...
- Declare these state paths in `defaults` (strict; no fallbacks):
  ...
  - `header.gap` (number; px; header ↔ content spacing; sets `--ck-header-gap` on `.ck-headerLayout`)
  - `header.innerGap` (number; px; header text ↔ CTA spacing; sets `--ck-header-inner-gap`)
  - `header.textGap` (number; px; title ↔ subtitle spacing; sets `--ck-header-text-gap`)
  - `cta.enabled` (boolean)
  - `cta.label` (string)
  - `cta.href` (string)
