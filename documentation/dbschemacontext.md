...
RLS: enabled
Primary key: id uuid
Columns: id, workspace_id uuid NOT NULL, entity_type text, entity_id uuid, event_type text NOT NULL, actor_id uuid, payload jsonb DEFAULT '{}', metadata jsonb DEFAULT '{}', idempotency_hash text, created_at timestamptz DEFAULT now()
embed_tokens
...
FK: public_id -> widget_instances.public_id
plugin_artifacts
