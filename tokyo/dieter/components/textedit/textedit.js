...
var Dieter = (() => {
  ...
  var textedit_exports = {};
  __export(textedit_exports, {
  ...
  var globalBindings = false;
  function hydrateTextedit(scope) {
    const roots = scope.querySelectorAll(".diet-textedit");
  ...
  function togglePopover(state, force) {
  ...
  function schedulePaletteUpdate(state, immediate = false) {
    if (immediate) {
  ...
  function updatePalettePosition(state, range) {
