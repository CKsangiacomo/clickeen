...
var Dieter = (() => {
  ...
  var REASON_KEY_VALUES = [
    ...
    "coreui.errors.account.publishingPaused",
  ...
  var REASON_KEY_GROUPS = {
    ...
    auth: REASON_KEY_VALUES.filter(
      (key) => key.includes(".auth.") || key.startsWith("AUTH_") || key.startsWith("GRANT_") || key === "CAPABILITY_DENIED" || key === "BUDGET_EXCEEDED"
    ),
